    ...
    public partial class Racer
    {
        public class Savestate : DataCollection
        {
            ...
            public void Init(Racer r)
            {
                ...
                GetValue(r, DataBlock.Path.Pod, (uint)Addr.Pod.TimeLap1, DataType.None, 0x19);
                GetValue(r, DataBlock.Path.PodState, 0, DataType.None, (uint)Addr.PtrLen.PodState);
                GetValue(r, Addr.Rendering.CameraMode);
                GetValue(r, Addr.Rendering.FogFlags);
                GetValue(r, DataBlock.Path.Rendering, (uint)Addr.Rendering.FogColR, DataType.None, 0x10);
                initialized = true;
            }
            ...
            public void Import(string filename)
            {
                ...
                while (file.Position < BitConverter.ToUInt16(inDataOff, 0) + BitConverter.ToUInt32(inDataLen, 0) - 4)
                {
                    ...
                    inDataBlocks.Add(new DataBlock(d,p,o,DataType.None));
